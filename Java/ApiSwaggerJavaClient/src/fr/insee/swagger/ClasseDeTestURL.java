...
public class ClasseDeTestURL {
	// TODO: Mettre la configuration appropri�e
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Test de la m�thode GET Sets by Type :");
	...
	/**
	 * M�thode de retour des Sets du repository
	 * 
	 * @param agency
	 * @param idParent
	 * @param version
	...
	/**
	 * M�thode de retour de la liste des Items du repository selon les
	 * Identifiers de la requ�te
	 * 
	 * @param agency
	 * @param idParent
	 * @param version
	...
	private void getListItemsByIdentifiers(List<Identifier> identifiers) throws IOException {
		...
		if (myUrl.toString().contains("https")) {
			// TODO: D�commenter pour utiliser le HTTPS
	...
	/**
	 * M�thode de retour de la liste des Items du repository pour un type
	 * sp�cifique
	 * 
	 * @param parentID
	 * @param itemType
	...
	private String getSetsByItemType(String parentID, String itemType, String agencyId, String version)
		...
		array.add(ids);
		// Ajout des propri�t�s requises (une correction sera effective sur la
		// V2
	...
	/**
	 * M�thode cr�ation d'un �venement (logger)dans le repository
	 */
