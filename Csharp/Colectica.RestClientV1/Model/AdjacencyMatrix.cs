...
namespace Colectica.RestClientV1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdjacencyMatrix :  IEquatable<AdjacencyMatrix>, IValidatableObject
    {
        /// <summary>
        ...
        public AdjacencyMatrix(List<Relationship> Edges = default(List<Relationship>), List<IdentifierTriple> Roots = default(List<IdentifierTriple>), bool? ReverseTraversal = default(bool?), Guid? Predicate = default(Guid?))
        {
            this.Edges = Edges;
            this.Roots = Roots;
        ...
        public List<Relationship> Edges { get; set; }
        /// <summary>
        /// Gets or Sets Roots
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AdjacencyMatrix);
        }

        /// <summary>
        /// Returns true if AdjacencyMatrix instances are equal
        /// </summary>
        /// <param name="other">Instance of AdjacencyMatrix to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdjacencyMatrix other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
