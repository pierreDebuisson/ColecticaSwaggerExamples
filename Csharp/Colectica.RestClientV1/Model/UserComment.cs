...
namespace Colectica.RestClientV1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserComment :  IEquatable<UserComment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserComment" /> class.
        /// </summary>
        ...
        public UserComment(string Comment = default(string), DateTime? CommentTime = default(DateTime?), string Username = default(string), Guid? Identifier = default(Guid?), long? Version = default(long?), string AgencyId = default(string))
        {
        ...
        /// <summary>
        /// Returns true if UserComment instances are equal
        /// </summary>
        /// <param name="other">Instance of UserComment to be compared</param>
        /// <returns>Boolean</returns>
