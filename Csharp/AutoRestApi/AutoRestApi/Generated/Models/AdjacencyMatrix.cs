...
namespace ApiRestColectica.Models
{
    ...
    public partial class AdjacencyMatrix
    {
        ...
        /// Initializes a new instance of the AdjacencyMatrix class.
        /// </summary>
        public AdjacencyMatrix(IList<Relationship> edges = default(IList<Relationship>), IList<IdentifierTriple> roots = default(IList<IdentifierTriple>), bool? reverseTraversal = default(bool?), System.Guid? predicate = default(System.Guid?))
        {
            Edges = edges;
            Roots = roots;
        ...
        public IList<Relationship> Edges { get; set; }
